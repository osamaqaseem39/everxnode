        ...
        <div className="grid grid-cols-1 md:grid-cols-8 gap-8 items-center">
          <div className="md:col-span-2">
            <div className="grid items-center mb-4">
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-semibold">EverXNode</h3>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex space-x-6">
              <a 
                ...
                className="text-gray-400 hover:text-[#D799FE] transition-colors duration-300"
              >
